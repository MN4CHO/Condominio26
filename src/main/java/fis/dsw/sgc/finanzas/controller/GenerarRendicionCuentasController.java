...
// Controlador de la vista Generar rendicion de cuentas
...
public class GenerarRendicionCuentasController {
    ...
    public void initialize() {
        ...
        setMensaje("Seleccione el periodo y pulse Generar reporte.", "message-info");
    }
    ...
    void generar(ActionEvent event) {
        ...
        // Valores de ejemplo hasta conectar con el servicio
        double agua = 320.00;
        double luz = 410.50;
        ...
        setMensaje(
                "Reporte de rendición de cuentas generado exitosamente. Disponible para consulta de los residentes.",
                "message-success"
        );
    }
    ...
    void limpiar(ActionEvent event) {
        ...
        lblResumen.setText("Genere un reporte para ver el desglose de ingresos y gastos.");
